...
from asana_goals.interactors.add_followers_interactor import (
    AddFollowersInteractor
)
from asana_goals.storages.storage_implementation import (
    StorageImplementation
)
from asana_goals.presenters.add_followers_presenter_implementation import (
    AddFollowersPresenterImplementation
)
...
class AddFollowersView(APIView):
    ...
    Matches Asana API: POST /goals/{goal_gid}/addFollowers
    """
...
Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.',
        ...
        request=AddFollowersRequestSerializer,
        responses={
            200: OpenApiResponse(
                response=AddFollowersResponseSerializer,
    ...
    def post(self, request, goal_gid: str):
        ...
        presenter = AddFollowersPresenterImplementation()
        interactor = AddFollowersInteractor(
            storage=storage,
            presenter=presenter
        )
        
        # Validate request data
        serializer = AddFollowersRequestSerializer(data=request.data)
        ...
        try:
            ...
            response = interactor.add_followers(
                goal_gid=goal_gid,
