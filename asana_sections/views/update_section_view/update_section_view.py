...
from asana_sections.interactors.update_section_interactor import (
    UpdateSectionInteractor
)
from asana_sections.storages.storage_implementation import (
    StorageImplementation
)
from asana_sections.presenters.update_section_presenter_implementation import (
    UpdateSectionPresenterImplementation
)
...
class UpdateSectionView(APIView):
    """
    Update a section
    Matches Asana API: PUT /sections/{section_gid}
    """
...
Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.',
        ...
        request=UpdateSectionRequestSerializer,
        responses={
            200: OpenApiResponse(
                response=UpdateSectionResponseSerializer,
    ...
    def put(self, request, section_gid: str):
        ...
        presenter = UpdateSectionPresenterImplementation()
        interactor = UpdateSectionInteractor(
            storage=storage,
            presenter=presenter
        )
        ...
        try:
            ...
            response = interactor.update_section(
