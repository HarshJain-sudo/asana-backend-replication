...
from asana_sections.interactors.insert_section_for_project_interactor import (
    InsertSectionForProjectInteractor
)
from asana_sections.storages.storage_implementation import (
    StorageImplementation
)
from asana_sections.presenters.insert_section_for_project_presenter_implementation import (
    InsertSectionForProjectPresenterImplementation
)
...
class InsertSectionForProjectView(APIView):
    """
    Move or Insert sections
    Matches Asana API: POST /projects/{project_gid}/sections/insert
    """
...
Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.',
        ...
        request=InsertSectionForProjectRequestSerializer,
        responses={
            200: OpenApiResponse(
                response=InsertSectionForProjectResponseSerializer,
    ...
    def post(self, request, project_gid: str):
        ...
        presenter = InsertSectionForProjectPresenterImplementation()
        interactor = InsertSectionForProjectInteractor(
            storage=storage,
            presenter=presenter
        )
        ...
        try:
            ...
            response = interactor.insert_section_for_project(
