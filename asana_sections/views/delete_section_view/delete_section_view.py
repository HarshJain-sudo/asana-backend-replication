...
from asana_sections.interactors.delete_section_interactor import (
    DeleteSectionInteractor
)
from asana_sections.storages.storage_implementation import (
    StorageImplementation
)
from asana_sections.presenters.delete_section_presenter_implementation import (
    DeleteSectionPresenterImplementation
)
...
class DeleteSectionView(APIView):
    """
    Delete a section
    Matches Asana API: DELETE /sections/{section_gid}
    """
...
Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.',
        ...
        responses={
            200: OpenApiResponse(
                response=DeleteSectionResponseSerializer,
    ...
    def delete(self, request, section_gid: str):
        ...
        presenter = DeleteSectionPresenterImplementation()
        interactor = DeleteSectionInteractor(
            storage=storage,
            presenter=presenter
        )
        ...
        try:
            ...
            response = interactor.delete_section(
