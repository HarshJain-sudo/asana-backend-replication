...
from asana_workspaces.presenters.update_workspace_presenter_implementation import (
    UpdateWorkspacePresenterImplementation
)
...
class UpdateWorkspaceView(APIView):
    """
    Update a workspace
    Matches Asana API: PUT /workspaces/{workspace_gid}
    """
...
Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.',
        ...
        request=UpdateWorkspaceRequestSerializer,
        responses={
            200: OpenApiResponse(
                response=UpdateWorkspaceResponseSerializer,
    ...
    def put(self, request, workspace_gid: str):
        ...
        presenter = UpdateWorkspacePresenterImplementation()
        ...
        try:
            ...
            response = interactor.update_workspace(
