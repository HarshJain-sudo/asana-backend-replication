...
from asana_tags.presenters.delete_tag_presenter_implementation import (
    DeleteTagPresenterImplementation
)
...
class DeleteTagView(APIView):
    """
    Delete a tag
    Matches Asana API: DELETE /tags/{tag_gid}
    """
...
Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.',
        ...
        responses={
            200: OpenApiResponse(
                response=DeleteTagResponseSerializer,
    ...
    def delete(self, request, tag_gid: str):
        ...
        presenter = DeleteTagPresenterImplementation()
        interactor = DeleteTagInteractor(
            storage=storage,
            presenter=presenter
        )
        ...
        try:
            ...
            response = interactor.delete_tag(
                tag_gid=tag_gid,
            )
