...
from asana_stories.interactors.delete_story_interactor import (
    DeleteStoryInteractor
)
from asana_stories.storages.storage_implementation import (
    StorageImplementation
)
from asana_stories.presenters.delete_story_presenter_implementation import (
    DeleteStoryPresenterImplementation
)
...
class DeleteStoryView(APIView):
    """
    Delete a story
    Matches Asana API: DELETE /stories/{story_gid}
    """
...
Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.',
        ...
        responses={
            200: OpenApiResponse(
                response=DeleteStoryResponseSerializer,
    ...
    def delete(self, request, story_gid: str):
        ...
        presenter = DeleteStoryPresenterImplementation()
        interactor = DeleteStoryInteractor(
            storage=storage,
            presenter=presenter
        )
        ...
        try:
            ...
            response = interactor.delete_story(
                story_gid=story_gid,
            )
