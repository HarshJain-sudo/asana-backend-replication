...
class GetCustomFieldSettingsForPortfolioView(APIView):
    """
    Get a portfolio's custom fields
    Matches Asana API: GET /portfolios/{portfolio_gid}/custom_field_settings
    """
...
*Note: You can only pass in an offset that was returned to you via a previously paginated request.*',
        ...
        responses={
            200: OpenApiResponse(
                response=GetCustomFieldSettingsForPortfolioResponseSerializer,
