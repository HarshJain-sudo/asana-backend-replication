...
class GetCustomFieldSettingsForGoalView(APIView):
    """
    Get a goal's custom fields
    Matches Asana API: GET /goals/{goal_gid}/custom_field_settings
    """
...
*Note: You can only pass in an offset that was returned to you via a previously paginated request.*',
        ...
        responses={
            200: OpenApiResponse(
                response=GetCustomFieldSettingsForGoalResponseSerializer,
    ...
    def get(self, request, goal_gid: str):
