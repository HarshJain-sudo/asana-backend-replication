...
from asana_teams.presenters.update_team_presenter_implementation import (
...
class UpdateTeamView(APIView):
    """
    Update a team
    Matches Asana API: PUT /teams/{team_gid}
    """
...
Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.',
        ...
        request=UpdateTeamRequestSerializer,
        responses={
            200: OpenApiResponse(
                response=UpdateTeamResponseSerializer,
    ...
    def put(self, request, team_gid: str):
        ...
        serializer = UpdateTeamRequestSerializer(data=request.data)
