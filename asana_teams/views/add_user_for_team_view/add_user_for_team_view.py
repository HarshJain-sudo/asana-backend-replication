...
from asana_teams.interactors.add_user_for_team_interactor import (
    AddUserForTeamInteractor
)
from asana_teams.storages.storage_implementation import (
    StorageImplementation
)
from asana_teams.presenters.add_user_for_team_presenter_implementation import (
    AddUserForTeamPresenterImplementation
)
...
class AddUserForTeamView(APIView):
    """
    Add a user to a team
    Matches Asana API: POST /teams/{team_gid}/addUser
    """
...
Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.',
        ...
        request=AddUserForTeamRequestSerializer,
        responses={
            200: OpenApiResponse(
                response=AddUserForTeamResponseSerializer,
    ...
    def post(self, request, team_gid: str):
        ...
        presenter = AddUserForTeamPresenterImplementation()
        interactor = AddUserForTeamInteractor(
            storage=storage,
            presenter=presenter
        )
        ...
        try:
            ...
            response = interactor.add_user_for_team(
                team_gid=team_gid,
