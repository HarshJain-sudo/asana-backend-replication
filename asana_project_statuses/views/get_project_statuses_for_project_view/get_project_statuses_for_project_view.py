...
class GetProjectStatusesForProjectView(APIView):
    """
    Get statuses from a project
    Matches Asana API: GET /projects/{project_gid}/project_statuses
    """
...
*Note: You can only pass in an offset that was returned to you via a previously paginated request.*',
        ...
        responses={
            200: OpenApiResponse(
                response=GetProjectStatusesForProjectResponseSerializer,
    ...
    def get(self, request, project_gid: str, project_gid: str):
