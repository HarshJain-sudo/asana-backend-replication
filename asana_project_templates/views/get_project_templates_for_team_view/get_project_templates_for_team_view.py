...
class GetProjectTemplatesForTeamView(APIView):
    """
    Get a team's project templates
    Matches Asana API: GET /teams/{team_gid}/project_templates
    """
...
*Note: You can only pass in an offset that was returned to you via a previously paginated request.*',
        ...
        responses={
            200: OpenApiResponse(
                response=GetProjectTemplatesForTeamResponseSerializer,
