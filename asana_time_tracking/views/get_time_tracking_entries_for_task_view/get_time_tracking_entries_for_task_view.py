...
class GetTimeTrackingEntriesForTaskView(APIView):
    """
    Get time tracking entries for a task
    Matches Asana API: GET /tasks/{task_gid}/time_tracking_entries
    """
...
*Note: You can only pass in an offset that was returned to you via a previously paginated request.*',
        ...
        responses={
            200: OpenApiResponse(
                response=GetTimeTrackingEntriesForTaskResponseSerializer,
