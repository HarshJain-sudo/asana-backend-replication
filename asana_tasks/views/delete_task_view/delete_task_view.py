...
from asana_tasks.presenters.delete_task_presenter_implementation import (
    DeleteTaskPresenterImplementation
)
...
class DeleteTaskView(APIView):
    """
    Delete a task
    Matches Asana API: DELETE /tasks/{task_gid}
    """
...
Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.',
        ...
        responses={
            200: OpenApiResponse(
                response=DeleteTaskResponseSerializer,
    ...
    def delete(self, request, task_gid: str):
        ...
        presenter = DeleteTaskPresenterImplementation()
        ...
        try:
            ...
            response = interactor.delete_task(
                task_gid=task_gid,
            )
