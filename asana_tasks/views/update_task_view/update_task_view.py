...
from asana_tasks.presenters.update_task_presenter_implementation import (
...
class UpdateTaskView(APIView):
    """
    Update a task
    Matches Asana API: PUT /tasks/{task_gid}
    """
...
Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.',
        ...
        responses={
            200: OpenApiResponse(
                response=UpdateTaskResponseSerializer,
    ...
    def put(self, request, task_gid: str):
        ...
        try:
            ...
            response = interactor.update_task(
                task_gid=task_gid,
