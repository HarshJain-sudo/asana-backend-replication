...
from asana_projects.interactors.update_project_interactor import (
    UpdateProjectInteractor
)
from asana_projects.storages.storage_implementation import (
    StorageImplementation
)
from asana_projects.presenters.update_project_presenter_implementation import (
...
Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.',
        ...
        request=UpdateProjectRequestSerializer,
        responses={
            200: OpenApiResponse(
                response=UpdateProjectResponseSerializer,
    ...
    def put(self, request, project_gid: str):
        ...
        try:
            ...
            response = interactor.update_project(
