...
from asana_projects.interactors.delete_project_interactor import (
    DeleteProjectInteractor
)
from asana_projects.storages.storage_implementation import (
    StorageImplementation
)
from asana_projects.presenters.delete_project_presenter_implementation import (
    DeleteProjectPresenterImplementation
)
...
Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.',
        ...
        responses={
            200: OpenApiResponse(
                response=DeleteProjectResponseSerializer,
    ...
    def delete(self, request, project_gid: str):
        ...
        presenter = DeleteProjectPresenterImplementation()
        ...
        try:
            ...
            response = interactor.delete_project(
