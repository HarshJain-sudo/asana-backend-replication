...
from asana_projects.interactors.project_save_as_template_interactor import (
    ProjectSaveAsTemplateInteractor
)
from asana_projects.storages.storage_implementation import (
    StorageImplementation
)
from asana_projects.presenters.project_save_as_template_presenter_implementation import (
    ProjectSaveAsTemplatePresenterImplementation
)
...
class ProjectSaveAsTemplateView(APIView):
    """
    Create a project template from a project
    Matches Asana API: POST /projects/{project_gid}/saveAsTemplate
    """
...
Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.',
        ...
        request=ProjectSaveAsTemplateRequestSerializer,
        responses={
            201: OpenApiResponse(
                response=ProjectSaveAsTemplateResponseSerializer,
    ...
    def post(self, request, project_gid: str):
        ...
        presenter = ProjectSaveAsTemplatePresenterImplementation()
        interactor = ProjectSaveAsTemplateInteractor(
            storage=storage,
            presenter=presenter
        )
        
        # Validate request data
        serializer = ProjectSaveAsTemplateRequestSerializer(data=request.data)
        ...
        try:
            ...
            response = interactor.project_save_as_template(
