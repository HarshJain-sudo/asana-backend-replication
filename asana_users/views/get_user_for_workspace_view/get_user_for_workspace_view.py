...
class GetUserForWorkspaceView(APIView):
    """
    Get a user in a workspace or organization
    Matches Asana API: GET /workspaces/{workspace_gid}/users/{user_gid}
    """
...
Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.',
        ...
        responses={
            200: OpenApiResponse(
                response=GetUserForWorkspaceResponseSerializer,
    ...
    def get(self, request, workspace_gid: str, user_gid: str):
