...
from asana_task_templates.interactors.delete_task_template_interactor import (
    DeleteTaskTemplateInteractor
)
from asana_task_templates.storages.storage_implementation import (
    StorageImplementation
)
from asana_task_templates.presenters.delete_task_template_presenter_implementation import (
    DeleteTaskTemplatePresenterImplementation
)
...
class DeleteTaskTemplateView(APIView):
    """
    Delete a task template
    Matches Asana API: DELETE /task_templates/{task_template_gid}
    """
...
Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.',
        ...
        responses={
            200: OpenApiResponse(
                response=DeleteTaskTemplateResponseSerializer,
    ...
    def delete(self, request, task_template_gid: str):
        ...
        presenter = DeleteTaskTemplatePresenterImplementation()
        interactor = DeleteTaskTemplateInteractor(
            storage=storage,
            presenter=presenter
        )
        ...
        try:
            ...
            response = interactor.delete_task_template(
